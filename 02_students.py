...
#<------- 탈출문자-------->
# 탈출문자 사용 예시
print("안녕하세요. \n저는 파이썬을 좋아합니다.")   # result : 
print("제가 가장 좋아하는 문장은 \"사랑합니다\"입니다.")  # result : 
print("C:\\Users\\Desktop")     # result : 
print("Red Apple\rPine")        # result :
print("Redd\b Apple")           # result : 
print("Red\tApple")             # result : 
